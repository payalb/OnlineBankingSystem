...
public class AccountModel {
	private String account_no, first_name, last_name, address, city, branch, zip, username, password, phone_number, email,
	...
	public void setPassword(String password) throws AccountInvalidException {
		if(password==null || password.length()<5) {
			//TODO matcher pattern for a regex: 1 special character, 1 numeric, 1 letter atleast
